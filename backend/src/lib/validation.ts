...
export const SaveProfileRequestSchema = z.object({
  ...
  profile: z.object({
    ...
    availability: z.enum(['immediate', 'offer_in_hand', '1_week', '2_weeks', '1_month', '2_months', '3_months', 'negotiable']),
    ...
    hackerrankUrl: z.string().url().nullable().optional(),
...
export const SearchRequestSchema = z.object({
  criteria: z.object({
    ...
    availability: z.array(z.enum(['immediate', 'offer_in_hand', '1_week', '2_weeks', '1_month', '2_months', '3_months', 'negotiable'])).optional(),
...
export const ScreenCandidateRequestSchema = z.object({
  ...
  updatedValues: z.object({
    ...
    availability: z.enum(['immediate', 'offer_in_hand', '1_week', '2_weeks', '1_month', '2_months', '3_months', 'negotiable']).optional(),
